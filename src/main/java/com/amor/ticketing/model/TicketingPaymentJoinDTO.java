...
public class TicketingPaymentJoinDTO {
	...
	public TicketingPaymentJoinDTO(int ticketing_idx, String movie_name, Date ticketing_reservetime,
			Date ticketing_screeningtime, String theater_name, String ticketing_personnel, String ticketing_seat,
			String ticketing_price) {
		super();
