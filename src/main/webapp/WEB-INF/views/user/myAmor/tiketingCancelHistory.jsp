...
<div class="mypagetitle"><a href = "ticketingHistory.do"><label class="title2">예매내역</label></a> <a href="cancelHistory.do"><label class="title1">취소내역</label></a></div>
</div></div>
