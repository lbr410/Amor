...
<div class="movieUpdatebox">
	<form name="movieUpdate" action="movieUpdated.do" class="movieUpdateform" method="post" enctype="multipart/form-data">
		...
		<div class="movieUpdateTextDiv">
			<table id="movieUpdateTextDivTable">
				<tr>
					<th>영화제목</th><td><input type="text" name="movie_name" placeholder="영화 제목을 입력해주세요" required="required" value="${dto.movie_name}"></td>
				</tr>
				<tr>
					<th>장르</th>
				...
				<tr>
					<th>감독</th><td><input type="text" name="movie_god" placeholder="감독을 입력해주세요" required="required" value="${dto.movie_god}" ></td>
				</tr>
				<tr>
					<th>배우</th><td><input type="text" name="movie_actor" placeholder="배우를 입력해주세요" required="required" value="${dto.movie_actor}" ></td>
				</tr>
				<tr>
					<th>연령제한</th>
				...
				<tr>
					<th>개봉날짜</th><td><input type="date" name="movie_opendate" placeholder="개봉 날짜를 입력해주세요" required="required" value="${dto.movie_opendate}"></td>
				</tr>
				<tr>	
					<th>러닝타임</th><td><input type="text" name="movie_runningtime" placeholder="러닝타임을 입력해주세요(단위 : 분)" required="required" value="${dto.movie_runningtime}"></td>
				</tr>
				<tr>
					<th>국적</th><td><input type="text" name="movie_country" placeholder="국적을 입력해주세요" required="required" value="${dto.movie_country}"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="movieUpdateSumit"><input type="submit" value="저장"> </td>
				</tr>
