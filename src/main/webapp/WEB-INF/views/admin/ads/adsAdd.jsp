...
<link rel="styleSheet" type="text/css" href="/amor/resources/css/admin/adsAdd.css">
	...
	<div class="adsAddFormDiv">
		<form name="adsAdd" action="adsAdd.do" method="post" enctype="multipart/form-data" onsubmit="return checkFileUpload()">
			...
			<table>
				...
				<tr>
					<td colspan="2" class="adsAddSumit">  <input type="button" value="취소" onclick="location.href='/amor/admin/ads/adsList.do'"> &nbsp; <input type="submit" value="저장"></td>
				</tr>
